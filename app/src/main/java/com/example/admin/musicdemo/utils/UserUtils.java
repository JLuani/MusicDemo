...
import com.example.admin.musicdemo.activitys.LoginActivity;
import com.example.admin.musicdemo.helps.RealmHelp;
import com.example.admin.musicdemo.helps.UserHelper;
import com.example.admin.musicdemo.models.UserModel;

import java.util.List;

/**
 * Created by yjl on 2020/2/1.
 */
...
//        用户当前输入的手机号是否已注册
         ...
         * 2、根据用户输入的手机号匹配查询的所有用户，如果可匹配则证明该手机号已经被注册，若不可则未注册
         */
        if (UserUtils.userExistFromPhone(phone)){
